...
def generate_tscn_multiple_collision_polygons_2d(polygons_coordinates, output_file="multiple_polygons.tscn"):
    """
    ...
    with open(output_file, "w") as f:
        f.write("[gd_scene load_steps=1 format=3 uid=\"uid://multiple_collision_polygons_gen\"]\n\n")
        f.write("[node name=\"PolygonsObjs\" type=\"StaticBody2D\"]\n\n")
...
# Wait for the 'Esc' key to break the loop
    if key == 27:        
        generate_tscn_multiple_collision_polygons_2d(detected_coordinates_blue, "multiple_polygons.tscn")
        break
